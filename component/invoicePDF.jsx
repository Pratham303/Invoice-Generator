...
const styles = StyleSheet.create({
  ...
  headerLeft: { flex: 1 },
  headerRight: { width: 200, textAlign: "right" },
  title: {
    fontSize: 32,
    fontWeight: "bold",
    color: "#1e1e1e",
  ...
  subtitle: { fontSize: 14, color: "#6b7288" },
  status: {
    fontSize: 14,
    padding: "8 16",
    borderRadius: 6,
  ...
  statusPaid: { backgroundColor: "#dcfce7", color: "#15883d" },
  statusPending: { backgroundColor: "#fff7ed", color: "#9a3412" },
  ...
  value: { fontSize: 14, color: "#1e1e1e", marginBottom: 4 },
  table: { marginTop: 30 },
  tableHeader: {
    flexDirection: "row",
  ...
  tableHeaderText: { fontSize: 12, color: "#6b7288", fontWeight: "bold" },
  tableRow: {
    flexDirection: "row",
    padding: "12 16",
    borderBottomWidth: 1,
  ...
  tableCell: { fontSize: 14, color: "#1e1e1e" },
  col1: { width: "40%" },
  ...
  totalLabel: { fontSize: 14, color: "#ffffff", opacity: 0.7 },
  totalAmount: { fontSize: 24, fontWeight: "bold", color: "#ffffff" },
  footer: {
    position: "absolute",
    bottom: 30,
    left: 50,
